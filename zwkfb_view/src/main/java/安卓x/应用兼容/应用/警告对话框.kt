 ...
 * 描述：置按钮
 */
fun AlertDialog.置按钮(哪个按钮: Int, 文本: CharSequence, 图标: Drawable, 监听器: DialogInterface.OnClickListener) =
...
fun AlertDialog.Builder.置视图(视图: View, 视图间距左: Int, 视图间距上: Int, 视图间距右: Int, 视图间距下: Int) : AlertDialog.Builder =
    this.setView(视图, 视图间距左, 视图间距上, 视图间距右, 视图间距下)
...
@SuppressLint("RestrictedApi")
fun AlertDialog.Builder.置测量时回收启用(启用: Boolean) : AlertDialog.Builder =
