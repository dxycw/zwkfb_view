 ...
 * change-transition in case we detected an illegal state in the {@link 滚动事件适配器}.
 *
 ...
 * LayoutTransitions?".
 */
final class 动画布局改变检测器 { //AnimateLayoutChangeDetector
    ...
    动画布局改变检测器(@NonNull LinearLayoutManager llm) {
        mLayoutManager = llm;
    }
