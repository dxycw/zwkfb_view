...
public final class 视图分页器2 extends ViewGroup {
     ...
     */
    public void setOrientation(@androidx.viewpager2.widget.ViewPager2.Orientation int orientation) {
        mLayoutManager.setOrientation(orientation);
        mAccessibilityProvider.onSetOrientation();
    }

    @SuppressLint("WrongConstant")
    public @androidx.viewpager2.widget.ViewPager2.Orientation int getOrientation() {
     ...
     *         androidx.viewpager2.widget.ViewPager2.OnPageChangeCallback#onPageScrollStateChanged(int)}
     */
    @SuppressLint("WrongConstant")
    @ScrollState
