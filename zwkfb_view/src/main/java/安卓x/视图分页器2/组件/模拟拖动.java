...
/**
 * Provides fake dragging functionality to {@link 视图分页器2}.
 */
final class 模拟拖动 { // FakeDrag
    private final 视图分页器2 mViewPager;
    private final 滚动事件适配器 mScrollEventAdapter;
    ...
    模拟拖动(视图分页器2 viewPager, 滚动事件适配器 scrollEventAdapter,
