 ...
 * for {@link androidx.viewpager2.widget.ViewPager2}. As part of this process, it keeps track of the current scroll position
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    ScrollEventAdapter(@NonNull 视图分页器2 viewPager) {
    ...
    private void updateScrollEventValues() {
        ...
        @SuppressLint("WrongConstant") boolean isHorizontal = mLayoutManager.getOrientation() == ORIENTATION_HORIZONTAL;
        int start, sizePx;
        if (isHorizontal) {
