...
class 材质底部信息对话框 : 材质底部面板对话框碎片() {
    ...
    override fun 初始视图函数(填充器: LayoutInflater, 容器: ViewGroup?) {
        super.初始视图函数(填充器, 容器)
        添加布局(R.layout.dialog_czdbxxdhk)
        初始代码()
    }
    ...
    private var 底部忽略按钮单击事件: 单击事件? = null
    private var 底部取消按钮单击事件: 单击事件? = null
    private var 底部确定按钮单击事件: 单击事件? = null
    ...
    private fun 初始代码() {
        ...
        横底部按钮框 = 查找视图id(R.id.hank)
        横底部忽略按钮 = 查找视图id(R.id.h_hlan)
        横底部忽略按钮?.text = 忽略按钮文本
        ...
        this.横底部忽略按钮?.setOnClickListener{ view ->
            if (底部忽略按钮单击事件 != null) {
                底部忽略按钮单击事件?.单击事件(requireDialog())
            }
        }

        横底部取消按钮 = 查找视图id(R.id.h_qxan)
        横底部取消按钮?.text = 取消按钮文本
        ...
        this.横底部取消按钮?.setOnClickListener{ view ->
            if (底部取消按钮单击事件 != null) {
                底部取消按钮单击事件?.单击事件(requireDialog())
            }
        }

        横底部确定按钮 = 查找视图id(R.id.h_qdan)
        横底部确定按钮?.text = 确定按钮文本
        ...
        this.横底部确定按钮?.setOnClickListener{ view ->
            if (底部确定按钮单击事件 != null) {
                底部确定按钮单击事件?.单击事件(requireDialog())
            }
        }


        竖底部按钮框 = 查找视图id(R.id.sank)
        竖底部忽略按钮 = 查找视图id(R.id.s_hlan)
        竖底部忽略按钮?.text = 忽略按钮文本
        if (忽略按钮文本 == null || 忽略按钮文本 == "") {
        ...
        this.竖底部确定按钮?.setOnClickListener{
            if (底部确定按钮单击事件 != null) {
                底部确定按钮单击事件?.单击事件(requireDialog())
            }
        }
    ...
    fun 置忽略按钮单击事件(文本: CharSequence, 事件: 单击事件): 材质底部信息对话框{
        this.忽略按钮文本 = 文本
        this.底部忽略按钮单击事件 = object : 单击事件 {
    ...
    fun 置忽略按钮单击事件(文本: CharSequence, 事件: (Dialog) -> Unit): 材质底部信息对话框{
        this.忽略按钮文本 = 文本
        this.底部忽略按钮单击事件 = object : 单击事件 {
            override fun 单击事件(对话框: Dialog) {
                事件(对话框)
    ...
    override fun 隐藏对话框子窗口状态栏(值: Boolean): 材质底部信息对话框 {
        super.隐藏对话框子窗口状态栏(值)
        return this
    }

    override fun 修复对话框子窗口导航栏遮盖问题(): 材质底部信息对话框 {
        super.修复对话框子窗口导航栏遮盖问题()
        return this
    }
