...
import 自定义.对话框.对话框类
import 自定义.状态栏类.刷新
import 自定义.状态栏类.导航栏图标自动深色模式
import 自定义.状态栏类.状态栏字体图标自动深色模式
import 自定义.状态栏类.状态栏导航栏透明
import 自定义.状态栏类.状态栏沉浸式
import 自定义.状态栏类.状态栏沉浸式类
import 自定义.系统类.是否为平板
import 自定义.网页工具.网页视图事件
...
//            网址: String?, 用户代理: String?, 内容处理: String?, 文件类型: String?, 内容长度: Long
            ...
            对话框类.浏览器下载对话框(上下文, url, userAgent!!, contentDisposition!!, mimetype!!)
        }
