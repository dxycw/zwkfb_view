...
public final class 加载指示器规范 {
    ...
    @NonNull
    int[] indicatorColors = new int[0];
    @ColorInt
    int containerColor;

    public 加载指示器规范(@NonNull Context context, @NonNull AttributeSet attrs) {
    ...
    private void loadIndicatorColors(@NonNull Context context, @NonNull TypedArray typedArray) {
        ...
        indicatorColors = context.getResources()
    ...
    /**
     * Sets the scale specs to fit the given bound of the {@link 加载指示器可绘制对象}.
     *
