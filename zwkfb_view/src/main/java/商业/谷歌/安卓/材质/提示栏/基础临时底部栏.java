 ...
 */
public abstract class 基础临时底部栏<B extends 基础临时底部栏<B>> {
    ...
    /**
     * Animation modes that can be set on the {@link 基础临时底部栏}.
     *
     * @hide
     */
    ...
    /**
     * Base class for {@link 基础临时底部栏} callbacks.
     *
     * @param <B> The transient bottom bar subclass.
     * @see 基础临时底部栏#addCallback(基础临时底部栏.BaseCallback)
     */
    public abstract static class BaseCallback<B> {
        ...
        /**
         * Called when the given {@link 基础临时底部栏} has been dismissed, either through a
         ...
         * @see 基础临时底部栏#dismiss()
         */
        public void onDismissed(B transientBottomBar, @BaseCallback.DismissEvent int event) {
            // empty
        }

        /**
         * Called when the given {@link 基础临时底部栏} is visible.
         *
    ...
    private static final String TAG = 基础临时底部栏.class.getSimpleName();
        ...
        handler = new Handler(
                        ...
                        new Handler.Callback() {
                            ...
                            public boolean handleMessage(@NonNull Message message) {
                                switch (message.what) {
                                    case MSG_SHOW:
                                        ((基础临时底部栏) message.obj).showView();
                                        return true;
                                    case MSG_DISMISS:
                                        ((基础临时底部栏) message.obj).hideView(message.arg1);
                                        return true;
                                    default:
                                        return false;
                                }
    ...
    private final Runnable bottomMarginGestureInsetRunnable =
            new Runnable() {
                ...
                public void run() {
                    ...
                    @SuppressLint("RestrictedApi") int screenHeight = WindowUtils.getCurrentWindowBounds(context).height();
     ...
     */
    protected 基础临时底部栏(@NonNull ViewGroup parent, @NonNull View content,
    ...
    @SuppressLint("RestrictedApi")
    protected 基础临时底部栏(@NonNull Context context, @NonNull ViewGroup parent, @NonNull View content,
            @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        if (parent == null) {
        ...
        if (content instanceof 提示栏内容布局) {
            ((提示栏内容布局) content).updateActionTextColorAlphaIfNeeded(view.getActionTextColorAlpha());
            ((提示栏内容布局) content).setMaxInlineActionWidth(view.getMaxInlineActionWidth());
        }
    ...
    private void updateMargins() {
        ...
        if (marginChanged || appliedBottomMarginGestureInset != extraBottomMarginGestureInset) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && shouldUpdateGestureInset()) {
     ...
     */
    @NonNull
    public B setDuration(@基础临时底部栏.Duration int duration) {
     ...
     */
    @NonNull
    public B setAnimationMode(@基础临时底部栏.AnimationMode int animationMode) {
        view.setAnimationMode(animationMode);
        return (B) this;
    }

    /**
     * Returns the anchor view for this {@link 基础临时底部栏}.
     *
    ...
    /** Sets the view the {@link 基础临时底部栏} should be anchored above. */
    @NonNull
    public B setAnchorView(@Nullable View anchorView) {
        if (this.anchor != null) {
            this.anchor.unanchor();
        }
        this.anchor = anchorView == null ? null : 基础临时底部栏.Anchor.anchor(this, anchorView);
        return (B) this;
    }

    /**
     * Sets the view the {@link 基础临时底部栏} should be anchored above by id.
     *
     ...
     * 基础临时底部栏} will recalculate and update its position when the position of the
    ...
    /**
     * Sets the {@link 基础临时底部栏.Behavior} to be used in this {@link
     * 基础临时底部栏}.
     *
     * @param behavior {@link 基础临时底部栏.Behavior} to be applied.
     */
    @NonNull
     ...
     * Return the behavior.
     *
     * @see #setBehavior(基础临时底部栏.Behavior)
     */
    public 基础临时底部栏.Behavior getBehavior() {
        return behavior;
    }

    /** Returns the {@link 基础临时底部栏}'s context. */
    @NonNull
    public Context getContext() {
        return context;
    }

    /** Returns the {@link 基础临时底部栏}'s view. */
    @NonNull
    public View getView() {
        return view;
    }

    /** Show the {@link 基础临时底部栏}. */
    public void show() {
        提示栏管理器.getInstance().show(getDuration(), managerCallback);
    }

    /** Dismiss the {@link 基础临时底部栏}. */
    public void dismiss() {
        dispatchDismiss(基础临时底部栏.BaseCallback.DISMISS_EVENT_MANUAL);
    }

    protected void dispatchDismiss(@基础临时底部栏.BaseCallback.DismissEvent int event) {
        提示栏管理器.getInstance().dismiss(managerCallback, event);
    }
     ...
     * @see #removeCallback(基础临时底部栏.BaseCallback)
     */
    @NonNull
    public B addCallback(@Nullable 基础临时底部栏.BaseCallback<B> callback) {
        if (callback == null) {
            return (B) this;
        }
        if (callbacks == null) {
     ...
     * @see #addCallback(基础临时底部栏.BaseCallback)
     */
    @NonNull
    public B removeCallback(@Nullable 基础临时底部栏.BaseCallback<B> callback) {
        if (callback == null) {
            return (B) this;
        }
        if (callbacks == null) {
    ...
    /** Return whether this {@link 基础临时底部栏} is currently being shown. */
    public boolean isShown() {
        return 提示栏管理器.getInstance().isCurrent(managerCallback);
    }

    /**
     * Returns whether this {@link 基础临时底部栏} is currently being shown, or is queued to
     * be shown next.
     */
    public boolean isShownOrQueued() {
        return 提示栏管理器.getInstance().isCurrentOrNext(managerCallback);
    }

    @NonNull
    提示栏管理器.Callback managerCallback =
            new 提示栏管理器.Callback() {
                @Override
                public void show() {
                    handler.sendMessage(handler.obtainMessage(MSG_SHOW, 基础临时底部栏.this));
                }

                @Override
                public void dismiss(int event) {
                    handler.sendMessage(
                            handler.obtainMessage(MSG_DISMISS, event, 0, 基础临时底部栏.this));
                }
            };

    @NonNull
    protected SwipeDismissBehavior<? extends View> getNewBehavior() {
        return new 基础临时底部栏.Behavior();
    }
        ...
        if (isShownOrQueued()) {
            ...
            handler.post(
                    new Runnable() {
                        @Override
                        public void run() {
                            onViewHidden(基础临时底部栏.BaseCallback.DISMISS_EVENT_MANUAL);
                        }
                    });
        }
    }
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams lp) {
        ...
        if (behavior instanceof 基础临时底部栏.Behavior) {
            ((基础临时底部栏.Behavior) behavior).setBaseTransientBottomBar(this);
        }
        ...
        behavior.setListener(
                new SwipeDismissBehavior.OnDismissListener() {
                    ...
                    public void onDismiss(@NonNull View view) {
                        ...
                        dispatchDismiss(基础临时底部栏.BaseCallback.DISMISS_EVENT_SWIPE);
                    }
                    ...
                    public void onDragStateChanged(int state) {
                        switch (state) {
                            ...
                            case SwipeDismissBehavior.STATE_SETTLING:
                                ...
                                提示栏管理器.getInstance().pauseTimeout(managerCallback);
                                break;
                            case SwipeDismissBehavior.STATE_IDLE:
                                // If the view has been released and is idle, restore the timeout
                                提示栏管理器.getInstance().restoreTimeoutIfPaused(managerCallback);
                                break;
                            default:
    ...
    final void hideView(@基础临时底部栏.BaseCallback.DismissEvent int event) {
    ...
    void onViewShown() {
        提示栏管理器.getInstance().onShown(managerCallback);
        if (callbacks != null) {
    ...
    void onViewHidden(int event) {
        ...
        提示栏管理器.getInstance().onDismissed(managerCallback);
        if (callbacks != null) {
            // Notify the callbacks. Do that from the end of the list so that if a callback
            // removes itself as the result of being called, it won't mess up with our iteration
            int callbackCount = callbacks.size();
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        @Nullable private 基础临时底部栏<?> baseTransientBottomBar;
        @Nullable
        ...
        private void setBaseTransientBottomBar(基础临时底部栏<?> baseTransientBottomBar) {
            this.baseTransientBottomBar = baseTransientBottomBar;
        }

        private void updateOriginalMargins(MarginLayoutParams params) {
            originalMargins = new Rect(params.leftMargin, params.topMargin, params.rightMargin, params.bottomMargin);
        }
        ...
        void removeOrRestorePaddingEnd(boolean remove) {
            setPaddingRelative(getPaddingStart(), getPaddingTop(), remove ? 0 : originalPaddingEnd,
                    getPaddingBottom()
            );
        }
    ...
    @NonNull
    private static GradientDrawable createGradientDrawableBackground(@ColorInt int backgroundColor, @NonNull Resources resources) {
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        private void setBaseTransientBottomBar(@NonNull 基础临时底部栏<?> baseTransientBottomBar) {
    ...
    public static class BehaviorDelegate {
        private 提示栏管理器.Callback managerCallback;
        ...
        public void setBaseTransientBottomBar(@NonNull 基础临时底部栏<?> baseTransientBottomBar) {
            this.managerCallback = baseTransientBottomBar.managerCallback;
        }

        public boolean canSwipeDismissView(View child) {
            return child instanceof 基础临时底部栏.SnackbarBaseLayout;
        }
    ...
    static class Anchor implements android.view.View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
        @NonNull
        private final WeakReference<基础临时底部栏> transientBottomBar;

        @NonNull
        private final WeakReference<View> anchorView;

        @SuppressLint("RestrictedApi")
        static 基础临时底部栏.Anchor anchor(@NonNull 基础临时底部栏 transientBottomBar, @NonNull View anchorView) {
        ...
        private Anchor(@NonNull 基础临时底部栏 transientBottomBar, @NonNull View anchorView) {
