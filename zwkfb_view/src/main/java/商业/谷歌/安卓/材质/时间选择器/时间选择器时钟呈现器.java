...
class 时间选择器时钟呈现器 implements 时钟指针视图.OnRotateListener, 时间选择器视图.OnSelectionChange,
    ...
    private final 时间选择器视图 timePickerView;
    ...
    public 时间选择器时钟呈现器(时间选择器视图 timePickerView, 时间模型 time) {
    ...
    void setSelection(@时间选择器控件.ActiveSelection int selection, boolean animate) {
