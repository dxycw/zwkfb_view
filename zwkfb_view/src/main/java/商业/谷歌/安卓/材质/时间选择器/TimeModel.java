...
class TimeModel implements Parcelable {
    ...
    @TimePickerControls.ActiveSelection
    int selection;
    @TimePickerControls.ClockPeriod
    int period;
    ...
    public TimeModel(int hour, int minute, @TimePickerControls.ActiveSelection int selection, @TimeFormat int format) {
        this.hour = hour;
        this.minute = minute;
    ...
    public void setPeriod(@TimePickerControls.ClockPeriod int period) {
