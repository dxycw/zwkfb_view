...
open class 提示栏 : BaseTransientBottomBar<提示栏> {
    ...
    fun setText(message: CharSequence): 提示栏 {
        this.getMessageView()!!.setText(message)
        return this
    }
    ...
    fun setAction(
        ...
        val tv: TextView = this.getActionView()
    ...
    fun setTextColor(colors: ColorStateList?): 提示栏 {
        this.getMessageView()!!.setTextColor(colors)
        return this
    }
    ...
    fun setTextMaxLines(maxLines: Int): 提示栏 {
        this.getMessageView()!!.setMaxLines(maxLines)
        return this
    }
    ...
    fun setActionTextColor(colors: ColorStateList?): 提示栏 {
        this.getActionView().setTextColor(colors)
        return this
    }
    ...
    fun setMaxInlineActionWidth(@Dimension width: Int): 提示栏 {
        this.getContentLayout()!!.setMaxInlineActionWidth(width)
        return this
    }
