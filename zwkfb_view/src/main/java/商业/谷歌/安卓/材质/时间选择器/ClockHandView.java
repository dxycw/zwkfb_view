...
import static 商业.谷歌.安卓.材质.时间选择器.RadialViewGroup.LEVEL_RADIUS_RATIO;
...
public class ClockHandView extends View {
    ...
    void setCurrentLevel(@RadialViewGroup.Level int level) {
        currentLevel = level;
        invalidate();
    }
    ...
    @Dimension
    private int getLeveledCircleRadius(@RadialViewGroup.Level int level) {
