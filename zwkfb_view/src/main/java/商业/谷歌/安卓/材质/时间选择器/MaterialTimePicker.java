...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final View onCreateView(
        ...
        ViewGroup root = (ViewGroup) layoutInflater.inflate(zwkfb.view.R.layout.material_timepicker_dialog, viewGroup);
    ...
    public static  class Builder { // final
        ...
        public MaterialTimePicker.Builder setInputMode(@InputMode int inputMode) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setHour(@IntRange(from = 0, to = 23) int hour) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setMinute(@IntRange(from = 0, to = 59) int minute) {
            time.setMinute(minute);
            return this;
        }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setTitleText(@StringRes int titleTextResId) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setPositiveButtonText(@StringRes int positiveButtonTextResId) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setPositiveButtonText(@Nullable CharSequence positiveButtonText) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setNegativeButtonText(@StringRes int negativeButtonTextResId) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setNegativeButtonText(@Nullable CharSequence negativeButtonText) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public MaterialTimePicker.Builder setTheme(@StyleRes int themeResId) {
