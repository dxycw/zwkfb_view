...
internal class 时间选择器视图 @JvmOverloads constructor(
    ...
    private val selectionListener: OnClickListener = object : OnClickListener {
    ...
    init {
        LayoutInflater.from(context).inflate(zwkfb.view.R.layout.material_timepicker, this)
        clockFace = findViewById<时钟表盘视图>(R.id.material_clock_face)
        toggle = findViewById<MaterialButtonToggleGroup>(R.id.material_clock_period_toggle)
        ...
        minuteView = findViewById<Chip>(R.id.material_minute_tv)
        hourView = findViewById<Chip>(R.id.material_hour_tv)
        clockHandView = findViewById<时钟指针视图>(R.id.material_clock_hand)
