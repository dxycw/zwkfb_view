...
import static 商业.谷歌.安卓.材质.时间选择器.时间选择器视图.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME;
 ...
 */
class 芯片文本输入组合视图 extends FrameLayout implements Checkable {
    ...
    public 芯片文本输入组合视图(@NonNull Context context) {
        this(context, null);
    }

    public 芯片文本输入组合视图(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public 芯片文本输入组合视图(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        watcher = new 芯片文本输入组合视图.TextFormatter();
