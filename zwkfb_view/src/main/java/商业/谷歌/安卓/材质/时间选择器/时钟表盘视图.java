 ...
 *
 * <p>It consists of a {@link 时钟指针视图} a list of the possible values evenly distributed across
 * a circle.
 */
class 时钟表盘视图 extends 径向视图组 implements 时钟指针视图.OnRotateListener {
    ...
    private 时钟表盘视图.OnEnterKeyPressedListener onEnterKeyPressedListener;

    public 时钟表盘视图(@NonNull Context context) {
        this(context, null);
    }

    public 时钟表盘视图(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.materialClockStyle);
    }

    @SuppressLint({"ClickableViewAccessibility", "RestrictedApi"})
    public 时钟表盘视图(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnEnterKeyPressedListener(时钟表盘视图.OnEnterKeyPressedListener onEnterKeyPressedListener) {
