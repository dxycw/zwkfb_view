 ...
 * @author dxyc
 */
//public class 标签布局 extends TabLayout {
//
//    public 标签布局(@NonNull Context 上下文) {
//        super(上下文);
//    }
//
//    public 标签布局(@NonNull Context 上下文, @Nullable AttributeSet 属性) {
//        super(上下文, 属性);
//    }
//
//    public 标签布局(@NonNull Context 上下文, @Nullable AttributeSet 属性, int 默认样式属性) {
//        super(上下文, 属性, 默认样式属性);
//    }
//
//
 ...
 *
 * <p>Population of the tabs to display is done through {@link 标签布局.Tab} instances. You create tabs via
 * {@link #newTab()}. From there you can change the tab's label or icon via {@link 标签布局.Tab#setText(int)}
 * and {@link 标签布局.Tab#setIcon(int)} respectively. To display the tab, you need to add it to the layout
 * via one of the {@link #addTab(标签布局.Tab)} methods. For example:
 *
 * <pre>
 * TabLayout tabLayout = ...;
 ...
 * </pre>
 *
 * You should add a listener via {@link #addOnTabSelectedListener(标签布局.OnTabSelectedListener)} to be
 * notified when any tab's selection state has been changed.
 *
 * <p>You can also add items to TabLayout in your layout through the use of {@link 标签项}. An
 ...
 */
@ViewPager.DecorView
public class 标签布局 extends HorizontalScrollView {
    ...
    private static final Pools.Pool<标签布局.Tab> tabPool = new Pools.SynchronizedPool<>(16);
    ...
    /**
     * If a tab is instantiated with {@link 标签布局.Tab#setText(CharSequence)}, and this mode is set, the text
     * will be saved and utilized for the content description, but no visible labels will be created.
     *
     * @see 标签布局.Tab#setTabLabelVisibility(int)
     */
    public static final int TAB_LABEL_VISIBILITY_UNLABELED = 0;

    /**
     * This mode is set by default. If a tab is instantiated with {@link 标签布局.Tab#setText(CharSequence)}, a
    ...
    /**
     * Gravity used to fill the {@link 标签布局} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link 标签布局}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Gravity used to lay out the tabs aligned to the start of the {@link 标签布局}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
     ...
     * 标签布局}. This will only take effect if the indicator height is set via the custom indicator
     ...
     * of the {@link 标签布局}. This will disregard {@code tabIndicatorHeight} and the
    ...
    public interface OnTabSelectedListener extends 标签布局.BaseOnTabSelectedListener<标签布局.Tab> {}

    /**
     * Callback interface invoked when a tab's selection state changes.
     *
     * @deprecated Use {@link 标签布局.OnTabSelectedListener} instead.
     */
    @Deprecated
    public interface BaseOnTabSelectedListener<T extends 标签布局.Tab> {
        /**
    ...
    private final ArrayList<标签布局.Tab> tabs = new ArrayList<>();
    @Nullable private 标签布局.Tab selectedTab;

    @NonNull final 标签布局.SlidingTabIndicator slidingTabIndicator;
    ...
    @标签布局.TabIndicatorAnimationMode
    int tabIndicatorAnimationMode;
    boolean unboundedRipple;

    private 标签指示器插值器 tabIndicatorInterpolator;
    private final TimeInterpolator tabIndicatorTimeInterpolator;

    @Nullable private 标签布局.BaseOnTabSelectedListener selectedListener;

    private final ArrayList<标签布局.BaseOnTabSelectedListener> selectedListeners = new ArrayList<>();
    @Nullable private 标签布局.BaseOnTabSelectedListener currentVpSelectedListener;
    ...
    private 标签布局.TabLayoutOnPageChangeListener pageChangeListener;
    private 标签布局.AdapterChangeListener adapterChangeListener;
    private boolean setupViewPagerImplicitly;
    private int viewPagerScrollState;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<标签布局.TabView> tabViewPool = new Pools.SimplePool<>(12);

    public 标签布局(@NonNull Context context) {
        this(context, null);
    }

    public 标签布局(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.tabStyle);
    }

    @SuppressLint("RestrictedApi")
    public 标签布局(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        slidingTabIndicator = new 标签布局.SlidingTabIndicator(context);
        super.addView(
                slidingTabIndicator,
                0,
     ...
     * and tinted right before it is drawn by {@link 标签布局.SlidingTabIndicator#draw(Canvas)}. If you'd like
    ...
    /**
     * Set the scroll position of the {@link 标签布局}.
     *
     ...
     */
    public void addTab(@NonNull 标签布局.Tab tab) {
     ...
     */
    public void addTab(@NonNull 标签布局.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull 标签布局.Tab tab, boolean setSelected) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull 标签布局.Tab tab, int position, boolean setSelected) {
        if (tab.parent != this) {
    ...
    private void addTabFromItemView(@NonNull 标签项 item) {
        final 标签布局.Tab tab = newTab();
        if (item.text != null) {
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(标签布局.OnTabSelectedListener)} and {@link
     *     #removeOnTabSelectedListener(标签布局.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable 标签布局.OnTabSelectedListener listener) {
        setOnTabSelectedListener((标签布局.BaseOnTabSelectedListener) listener);
    }
     ...
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable 标签布局.BaseOnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link 标签布局.OnTabSelectedListener} that will be invoked when tab selection changes.
     *
     ...
     */
    public void addOnTabSelectedListener(@NonNull 标签布局.OnTabSelectedListener listener) {
        addOnTabSelectedListener((标签布局.BaseOnTabSelectedListener) listener);
    }

    /**
     * Add a {@link 标签布局.BaseOnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via {@link
     * #removeOnTabSelectedListener(标签布局.BaseOnTabSelectedListener)}.
     *
     * @param listener listener to add
     * @deprecated use {@link #addOnTabSelectedListener(标签布局.OnTabSelectedListener)}
     */
    @Deprecated
    public void addOnTabSelectedListener(@Nullable 标签布局.BaseOnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link 标签布局.OnTabSelectedListener} that was previously added via {@link
     * #addOnTabSelectedListener(标签布局.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull 标签布局.OnTabSelectedListener listener) {
        removeOnTabSelectedListener((标签布局.BaseOnTabSelectedListener) listener);
    }

    /**
     * Remove the given {@link 标签布局.BaseOnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(标签布局.BaseOnTabSelectedListener)}.
     *
     * @param listener listener to remove
     * @deprecated use {@link #removeOnTabSelectedListener(标签布局.OnTabSelectedListener)}
     */
    @Deprecated
    public void removeOnTabSelectedListener(@Nullable 标签布局.BaseOnTabSelectedListener listener) {
        selectedListeners.remove(listener);
    }

    /** Remove all previously added {@link 标签布局.OnTabSelectedListener}s. */
    public void clearOnTabSelectedListeners() {
        selectedListeners.clear();
    }

    /**
     * Create and return a new {@link 标签布局.Tab}. You need to manually add this using {@link #addTab(标签布局.Tab)}
     * or a related method.
     *
     * @return A new Tab
     * @see #addTab(标签布局.Tab)
     */
    @NonNull
    public 标签布局.Tab newTab() {
        标签布局.Tab tab = createTabFromPool();
        tab.parent = this;
    ...
    protected 标签布局.Tab createTabFromPool() {
        标签布局.Tab tab = tabPool.acquire();
        if (tab == null) {
            tab = new 标签布局.Tab();
        }
        return tab;
    ...
    // TODO(b/76413401): remove this method and just create the final field after the widget migration
    protected boolean releaseFromTabPool(标签布局.Tab tab) {
    ...
    @Nullable
    public 标签布局.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(@NonNull 标签布局.Tab tab) {
        if (tab.parent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final 标签布局.Tab removedTab = tabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<标签布局.Tab> i = tabs.iterator(); i.hasNext(); ) {
            final 标签布局.Tab tab = i.next();
            i.remove();
            tab.reset();
     ...
     */
    public void setTabMode(@标签布局.Mode int mode) {
        if (mode != this.mode) {
            this.mode = mode;
            applyModeAndGravity();
        }
    ...
    /**
     * Returns the current mode used by this {@link 标签布局}.
     *
     * @see #setTabMode(int)
     */
    @标签布局.Mode
     ...
     */
    public void setTabGravity(@标签布局.TabGravity int gravity) {
    ...
    /**
     * Set the indicator gravity used to align the tab selection indicator in the {@link 标签布局}.
     ...
     * indicator height and stretch across the entire height of the {@link 标签布局}. This
     ...
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabIndicatorGravity
     */
    public void setSelectedTabIndicatorGravity(@标签布局.TabIndicatorGravity int indicatorGravity) {
    ...
    public void setTabIndicatorAnimationMode(
            @标签布局.TabIndicatorAnimationMode int tabIndicatorAnimationMode) {
        ...
        switch (tabIndicatorAnimationMode) {
            case INDICATOR_ANIMATION_MODE_LINEAR:
                this.tabIndicatorInterpolator = new 标签指示器插值器();
                break;
            case INDICATOR_ANIMATION_MODE_ELASTIC:
                this.tabIndicatorInterpolator = new 弹性标签指示器插值器();
                break;
            case INDICATOR_ANIMATION_MODE_FADE:
                this.tabIndicatorInterpolator = new 淡出标签指示器插值器();
                break;
            default:
    ...
    public void setInlineLabel(boolean inline) {
        if (inlineLabel != inline) {
            ...
            for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
                ...
                if (child instanceof 标签布局.TabView) {
                    ((标签布局.TabView) child).updateOrientation();
                }
            }
            applyModeAndGravity();
        }
    ...
    /**
     * Set whether this {@link 标签布局} will have an unbounded ripple effect or if ripple will be
    ...
    public void setUnboundedRipple(boolean unboundedRipple) {
        if (this.unboundedRipple != unboundedRipple) {
            ...
            for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
                View child = slidingTabIndicator.getChildAt(i);
                if (child instanceof 标签布局.TabView) {
                    ((标签布局.TabView) child).updateBackgroundDrawable(getContext());
                }
            }
        }
    }
    ...
    /**
     * Returns whether this {@link 标签布局} has an unbounded ripple effect, or if ripple is bound to
     * the tab item size.
     *
     ...
     *
     * <p>Setting the indicator drawable to null will cause {@link 标签布局} to use the default,
    ...
    /**
     * The one-stop shop for setting up this {@link 标签布局} with a {@link ViewPager}.
     *
    ...
    private void setupWithViewPager(
        ...
        if (viewPager != null) {
            ...
            if (pageChangeListener == null) {
                pageChangeListener = new 标签布局.TabLayoutOnPageChangeListener(this);
            }
            pageChangeListener.reset();
            viewPager.addOnPageChangeListener(pageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            currentVpSelectedListener = new 标签布局.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (adapterChangeListener == null) {
                adapterChangeListener = new 标签布局.AdapterChangeListener();
            }
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (pagerAdapterObserver == null) {
                pagerAdapterObserver = new 标签布局.PagerAdapterObserver();
            }
    ...
    @NonNull
    private 标签布局.TabView createTabView(@NonNull final 标签布局.Tab tab) {
        标签布局.TabView tabView = tabViewPool != null ? tabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new 标签布局.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(@NonNull 标签布局.Tab tab, int position) {
    ...
    private void addTabView(@NonNull 标签布局.Tab tab) {
        final 标签布局.TabView tabView = tab.view;
    ...
    private void addViewInternal(final View child) {
        if (child instanceof 标签项) {
            addTabFromItemView((标签项) child);
            //=============================================新增的=======================
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
            ...
            if (tabView instanceof 标签布局.TabView) {
                ((标签布局.TabView) tabView).drawBackground(canvas);
            }
        }
    ...
    private void removeTabViewAt(int position) {
        final 标签布局.TabView view = (标签布局.TabView) slidingTabIndicator.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == 标签布局.Tab.INVALID_POSITION) {
            return;
        }
     ...
     * @see #selectTab(标签布局.Tab, boolean)
     */
    public void selectTab(@Nullable 标签布局.Tab tab) {
        selectTab(tab, true);
    }
     ...
     * @see #selectTab(标签布局.Tab)
     */
    public void selectTab(@Nullable final 标签布局.Tab tab, boolean updateIndicator) {
        final 标签布局.Tab currentTab = selectedTab;
        ...
        if (currentTab == tab) {
            ...
            final int newPosition = tab != null ? tab.getPosition() : 标签布局.Tab.INVALID_POSITION;
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == 标签布局.Tab.INVALID_POSITION)
                        && newPosition != 标签布局.Tab.INVALID_POSITION) {
    ...
    private void dispatchTabSelected(@NonNull final 标签布局.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
            selectedListeners.get(i).onTabSelected(tab);
        }
    }

    private void dispatchTabUnselected(@NonNull final 标签布局.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
            selectedListeners.get(i).onTabUnselected(tab);
        }
    }

    private void dispatchTabReselected(@NonNull final 标签布局.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
    ...
    public static class Tab {
        ...
        private @标签布局.LabelVisibility int labelVisibilityMode = TAB_LABEL_VISIBILITY_LABELED;

        // TODO(b/76413401): make package private after the widget migration is finished
        @Nullable public 标签布局 parent;
        // TODO(b/76413401): make package private after the widget migration is finished
        @NonNull public 标签布局.TabView view;
        ...
        public 标签布局.Tab setTag(@Nullable Object tag) {
            this.tag = tag;
            return this;
        }
         ...
         *
         * <p>Do not rely on this if using {@link 标签布局#setupWithViewPager(ViewPager)}
         *
         * @param id unique id for this tab
         */
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setId(int id) {
            this.id = id;
            if (view != null) {
                view.setId(id);
            }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setCustomView(@Nullable View view) {
            customView = view;
            updateView();
            return this;
        }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setCustomView(@LayoutRes int resId) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setIcon(@Nullable Drawable icon) {
            this.icon = icon;
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setIcon(@DrawableRes int resId) {
            if (parent == null) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setText(@Nullable CharSequence text) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setText(@StringRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setTabLabelVisibility(@标签布局.LabelVisibility int mode) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setContentDescription(@StringRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public 标签布局.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    /** A {@link LinearLayout} containing {@link 标签布局.Tab} instances for use with {@link 标签布局}. */
    public final class TabView extends LinearLayout {
        private 标签布局.Tab tab;
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                标签布局.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
            }
        }
        ...
        void setTab(@Nullable final 标签布局.Tab tab) {
            if (tab != this.tab) {
                this.tab = tab;
                update();
            }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private void jumpIndicatorToPosition(int position) {
            ...
            tabIndicatorInterpolator.setIndicatorBoundsForTab(
                    标签布局.this, currentView, tabSelectedIndicator);
        ...
        private void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            ...
            if (hasVisibleTitle) {
                tabIndicatorInterpolator.updateIndicatorForOffset(
                        标签布局.this, startTitle, endTitle, fraction, tabSelectedIndicator);
            } else {
     ...
     * provided {@link 标签布局} so that the tab position is kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull private final WeakReference<标签布局> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        public TabLayoutOnPageChangeListener(标签布局 tabLayout) {
        ...
        public void onPageScrollStateChanged(final int state) {
            ...
            scrollState = state;
            标签布局 tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
        ...
        public void onPageScrolled(
            ...
            final 标签布局 tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link 标签布局.OnTabSelectedListener} class which contains the necessary calls back to the
     * provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements 标签布局.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(@NonNull 标签布局.Tab tab) {
            viewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(标签布局.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(标签布局.Tab tab) {
            // No-op
        }
    }
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (标签布局.this.viewPager == viewPager) {
