...
public final class 加载指示器 extends View implements Drawable.Callback {
    ...
    @NonNull private final 加载指示器可绘制对象 drawable;
    @NonNull private final 加载指示器规范 specs;
    ...
    public 加载指示器(@NonNull Context context) {
        this(context, null);
    }

    public 加载指示器(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.loadingIndicatorStyle);
    }

    @SuppressLint("RestrictedApi")
    public 加载指示器(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes final int defStyleAttr) {
        ...
        drawable = 加载指示器可绘制对象.create(
                        context, new 加载指示器规范(context, attrs, defStyleAttr));
    ...
    /**
     * If the component and needs to be hidden with
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        加载指示器绘制代理 drawingDelegate = drawable.getDrawingDelegate();
     ...
     * generally only occur through usage of {@link android.view.ViewGroup(View)}
     ...
     * android.view.ViewGroup(View, int, ViewGroup.LayoutParams)}, which *can*
    ...
    /** Returns the {@link 加载指示器可绘制对象} object used in this loading indicator. */
    @NonNull
    public 加载指示器可绘制对象 getDrawable() {
        return drawable;
    }
    ...
    public void setAnimatorDurationScaleProvider(
            @SuppressLint("RestrictedApi") @NonNull AnimatorDurationScaleProvider animatorDurationScaleProvider) {
