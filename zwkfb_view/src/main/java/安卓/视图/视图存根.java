...
public final class 视图存根 extends View {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.Q)
    public 视图存根(Context context, @LayoutRes int layoutResource) {
        this(context, null);
    ...
    @RequiresApi(api = Build.VERSION_CODES.Q)
    public 视图存根(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.Q)
    public 视图存根(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.Q)
    public 视图存根(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context);

        final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.视图存根, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.视图存根, attrs, a, defStyleAttr,
                defStyleRes);
     ...
     * inflated its layout resource.
     *
     * @see 视图存根#setOnInflateListener(OnInflateListener)
     */
    public static interface OnInflateListener {
         ...
         */
        void onInflate(视图存根 stub, View inflated);
    }
