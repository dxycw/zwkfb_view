...
final class 视图存根 : View {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) :
        ...
        context.withStyledAttributes(attrs, R.styleable.视图存根, defStyleAttr, defStyleRes) {
            mInflatedId = getResourceId(R.styleable.视图存根_android_inflatedId, NO_ID)
            mLayoutResource = getResourceId(R.styleable.视图存根_android_layout, 0)
            setId(getResourceId(R.styleable.视图存根_android_id, NO_ID))
        }
