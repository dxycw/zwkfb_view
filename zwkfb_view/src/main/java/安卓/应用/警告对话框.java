...
public class 警告对话框 extends AlertDialog implements 对话框接口 {
    ...
    public static final int 主题_传统 = AlertDialog.THEME_TRADITIONAL;

    public static final int 主题_全息_深色 = AlertDialog.THEME_HOLO_DARK;

    public static final int 主题_全息_浅色 = AlertDialog.THEME_HOLO_LIGHT;

    public static final int 主题_设备_默认_深色 = AlertDialog.THEME_DEVICE_DEFAULT_DARK;

    public static final int 主题_设备_默认_浅色 = AlertDialog.THEME_DEVICE_DEFAULT_LIGHT;
     ...
     * 描述：置按钮
     */
    public void 置按钮(CharSequence 文本, Message 信息) {
     ...
     * 描述：置按钮2
     */
    public void 置按钮2(CharSequence 文本, Message 信息) {
        this.setButton(文本, 信息);
    }
     ...
     * 描述：置按钮3
     */
    public void 置按钮3(CharSequence 文本, Message 信息) {
        this.setButton(文本, 信息);
    }
     ...
     * 描述：置按钮
     */
    public void 置按钮(CharSequence 文本, final OnClickListener 监听器) {
     ...
     * 描述：置按钮2
     */
    public void 置按钮2(CharSequence 文本, final OnClickListener 监听器) {
        this.setButton(文本, 监听器);
    }
     ...
     * 描述：置按钮3
     */
    public void 置按钮3(CharSequence 文本, final OnClickListener 监听器) {
        this.setButton(文本, 监听器);
    }
     ...
     * 描述：置图标
     */
    public void 置图标(@DrawableRes int 资源Id) {
        this.setIcon(资源Id);
    }
     ...
     * 描述：置图标属性
     */
    public void 置图标属性(@AttrRes int 属性Id) {
     ...
     * 描述：置强制反向背景
     */
    public void 置强制反向背景(boolean 强制反转背景) {
        this.setInverseBackgroundForced(强制反转背景);
    }
...
//    }
    ...
    public static class 构建器 extends AlertDialog.Builder {
        ...
        public 构建器 置标题(CharSequence 标题) {
            this.setTitle(标题);
            return this;
        }

        public 构建器 置自定义标题(View 自定义标题视图) {
            this.setCustomTitle(自定义标题视图);
            return this;
        }
        ...
        public 构建器 置消息(CharSequence 消息) {
            this.setMessage(消息);
            return this;
        }
