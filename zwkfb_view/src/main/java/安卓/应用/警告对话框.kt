 ...
 * 描述：置强制反向背景
 */
fun AlertDialog.置强制反向背景(强制反转背景: Boolean) = this.setInverseBackgroundForced(强制反转背景)
 ...
 * 描述：置多选项目
 */
fun AlertDialog.Builder.置多选项目(@ArrayRes 项目Id: Int, 已选项目: BooleanArray, 监听器: DialogInterface.OnMultiChoiceClickListener) : AlertDialog.Builder =
    this.setMultiChoiceItems(项目Id,已选项目,监听器)

/**
 * 描述：置多选项目
 */
fun AlertDialog.Builder.置多选项目(项目: Array<CharSequence>, 已选项目: BooleanArray, 监听器: DialogInterface.OnMultiChoiceClickListener) : AlertDialog.Builder =
 ...
 * 描述：置单选项目
 */
fun AlertDialog.Builder.置单选项目(@ArrayRes 项目Id: Int, 已选项目: Int, 监听器: DialogInterface.OnClickListener) : AlertDialog.Builder =
    this.setSingleChoiceItems(项目Id,已选项目,监听器)

/**
 * 描述：置单选项目
 */
fun AlertDialog.Builder.置单选项目(光标 : Cursor, 已选项目: Int, 标签列: String, 监听器: DialogInterface.OnClickListener) : AlertDialog.Builder =
    this.setSingleChoiceItems(光标,已选项目,标签列,监听器)

/**
 * 描述：置单选项目
 */
fun AlertDialog.Builder.置单选项目(项目: Array<CharSequence>, 已选项目: Int, 监听器: DialogInterface.OnClickListener) : AlertDialog.Builder =
    this.setSingleChoiceItems(项目,已选项目,监听器)

/**
 * 描述：置单选项目
 */
fun AlertDialog.Builder.置单选项目(适配器: ListAdapter, 已选项目: Int, 监听器: DialogInterface.OnClickListener) : AlertDialog.Builder =
 ...
 * 描述：置强制反向背景
 */
fun AlertDialog.Builder.置强制反向背景(使用反向背景: Boolean): AlertDialog.Builder =
...
/**
 * 使用此构建器提供的参数创建一个 `警告对话框`，并立即显示该对话框。调用此方法在功能上等同于：
 * ```
 *  警告对话框 对话框 = 构建器.创建();
 *  对话框.显示();
 * ```
