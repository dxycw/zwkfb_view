...
open class 警告对话框 : AlertDialog {
     ...
     * 描述：置按钮
     */
    open fun 置按钮(文本: CharSequence, 信息: Message) {
        super.setButton(文本,信息)
    }
     ...
     * 描述：置按钮2
     */
    open fun 置按钮2(文本: CharSequence, 信息: Message) {
        super.setButton2(文本,信息)
    }
     ...
     * 描述：置按钮3
     */
    open fun 置按钮3(文本: CharSequence, 信息: Message) {
        super.setButton3(文本,信息)
    }
     ...
     * 描述：置按钮
     */
    open fun 置按钮(文本: CharSequence, 监听器: DialogInterface.OnClickListener) {
        super.setButton(文本,监听器)
    }

    /**
     * 描述：置按钮2
     */
    open fun 置按钮2(文本: CharSequence, 监听器: DialogInterface.OnClickListener) {
        super.setButton2(文本,监听器)
    }

    /**
     * 描述：置按钮3
     */
    open fun 置按钮3(文本: CharSequence, 监听器: DialogInterface.OnClickListener) {
        super.setButton3(文本,监听器)
    }
     ...
     * 描述：置图标
     */
    open fun 置图标(@DrawableRes 资源Id: Int) {
        super.setIcon(资源Id)
    }
     ...
     * 描述：置强制反色背景
     */
    open fun 置强制反色背景(是否强制反色背景: Boolean) {
        super.setInverseBackgroundForced(是否强制反色背景)
    }
